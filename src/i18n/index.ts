...
const englishMessages: MessageCatalog = {
  ...
  "cli.error.baselineNotFound": "Baseline report was not found at `{path}`.",
  "cli.error.baselineUnreadable": "Baseline report could not be read from `{path}`.",
  "cli.error.baselineInvalidJson": "Baseline report at `{path}` is not valid JSON.",
  "cli.error.baselineInvalidShape":
    "Baseline report at `{path}` is not a valid Preflight JSON scan report.",
  "cli.error.annotationsUnsupported":
    "Unsupported annotations target `{target}`. Supported targets: github.",
  ...
  "output.baseline.title": "Baseline Diff",
  "output.baseline.comparedAgainst": "Compared Against",
  "output.baseline.scannedAt": "Baseline Scanned At",
  "output.baseline.new": "New Findings",
  "output.baseline.resolved": "Resolved Findings",
  "output.baseline.summaryLine": "{newCount} new / {resolvedCount} resolved",
  "output.baseline.noChanges":
    "No blocking issues, warnings, or missing inputs changed versus the baseline.",
  "output.baseline.blockingIssuesNew": "New Blocking Issues",
  "output.baseline.blockingIssuesResolved": "Resolved Blocking Issues",
  "output.baseline.warningsNew": "New Warnings",
  "output.baseline.warningsResolved": "Resolved Warnings",
  "output.baseline.missingInputsNew": "New Missing Inputs",
...
const turkishMessages: MessageCatalog = {
  ...
  "cli.error.baselineNotFound": "Baseline raporu `{path}` konumunda bulunamadi.",
  "cli.error.baselineUnreadable": "Baseline raporu `{path}` konumundan okunamadi.",
  "cli.error.baselineInvalidJson":
    "`{path}` konumundaki baseline raporu gecerli JSON degil.",
  "cli.error.baselineInvalidShape":
    "`{path}` konumundaki baseline raporu gecerli bir Preflight JSON tarama raporu degil.",
  "cli.error.annotationsUnsupported":
    "Desteklenmeyen annotations hedefi `{target}`. Desteklenen hedefler: github.",
  "cli.error.langFallback":
  ...
  "output.baseline.title": "Baseline Farki",
  "output.baseline.comparedAgainst": "Karsilastirilan Rapor",
  "output.baseline.scannedAt": "Baseline Tarama Zamani",
  "output.baseline.new": "Yeni Bulgular",
  "output.baseline.resolved": "Cozulen Bulgular",
  "output.baseline.summaryLine": "{newCount} yeni / {resolvedCount} cozuldu",
  "output.baseline.noChanges":
    "Baseline'e gore blocking issue, warning veya missing input degismedi.",
  "output.baseline.blockingIssuesNew": "Yeni Blocking Issues",
  "output.baseline.blockingIssuesResolved": "Cozulen Blocking Issues",
  "output.baseline.warningsNew": "Yeni Warnings",
  "output.baseline.warningsResolved": "Cozulen Warnings",
  "output.baseline.missingInputsNew": "Yeni Missing Inputs",
